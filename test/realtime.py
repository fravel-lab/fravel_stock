...
ACCESS_TOKEN = '_tSIahqcA2Neb7c4J4S7UEqssETHWv7VSZBy9tBZRngUCobzqR00rQ7AcTsbHM-U7etjBGSDe35yzjWTf1v63g'  # 고객 Access Token
...
async def main():
	...
	await websocket_client.send_message({ # 005930 추가 등록
        'trnm': 'REG',
        'grp_no': '1',
        'refresh': '1',   # ⭐ 기존 등록 유지 + 추가
        'data': [{
            'item': [''],
            'type': ['00'],
        }]
